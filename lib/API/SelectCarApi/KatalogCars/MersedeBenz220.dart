...
class MersedesBenz220 extends StatefulWidget {
  const MersedesBenz220({super.key});

  @override
  State<MersedesBenz220> createState() => _MersedesBenz220State();
}

class _MersedesBenz220State extends State<MersedesBenz220> {
    List<String> images = ["assets/mersedesbenz222.png", "assets/mersedesbenz222.png"];
  String title = "Mersedec-Benz 220";
  String names = "Mersedec-Benz";
  @override
