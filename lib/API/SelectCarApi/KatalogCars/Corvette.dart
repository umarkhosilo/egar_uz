...
class ChevroletCorvette extends StatefulWidget {
  const ChevroletCorvette({super.key});

  @override
  State<ChevroletCorvette> createState() => _ChevroletCorvetteState();
}

class _ChevroletCorvetteState extends State<ChevroletCorvette> {
  List<String> images = ["assets/ChevroletCorvette.png", "assets/ChevroletCorvette.png"];
  String title = "Chevrolet Corvette";
  String names = "Chevrolet";
