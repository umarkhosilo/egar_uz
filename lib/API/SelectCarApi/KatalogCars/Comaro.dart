...
class ChevroletComaro extends StatefulWidget {
  const ChevroletComaro({super.key});

  @override
  State<ChevroletComaro> createState() => _ChevroletComaroState();
}

class _ChevroletComaroState extends State<ChevroletComaro> {
  List<String> images = ["assets/ChevroletCamaro.png", "assets/ChevroletCamaro.png"];
  String title = "Chevrolet Comaro";
